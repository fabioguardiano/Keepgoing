...
interface SettingsViewProps {
    ...
    initialTab?: 'fluxo' | 'vendas' | 'empresa' | 'dados' | 'geral' | 'permissoes' | 'auditoria';
    currentUser?: User;
...
export const SettingsView: React.FC<SettingsViewProps> = ({
    ...
    const [activeTab, setActiveTab] = useState<'fluxo' | 'vendas' | 'empresa' | 'dados' | 'geral' | 'permissoes' | 'auditoria'>(initialTab || 'fluxo');
