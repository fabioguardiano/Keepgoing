-- MIGRATION: SCHEMA COMPLETO + RLS + FINANCE TRANSACTIONS
-- Script auto-suficiente. Pode ser executado em banco vazio ou já existente.
...
-- =============================================================================
-- 5. AUDITORIA, ENTREGAS E FINANCEIRO
-- =============================================================================
...
-- =============================================================================
-- 6. RLS: ISOLAMENTO REAL POR EMPRESA
--    Só processa tabelas que de fato existem no banco.
-- =============================================================================
DO $$
DECLARE
    t text;
...
CREATE INDEX IF NOT EXISTS idx_orders_company_id            ON orders_service(company_id);
CREATE INDEX IF NOT EXISTS idx_orders_os_number             ON orders_service(os_number);
CREATE INDEX IF NOT EXISTS idx_orders_created_at            ON orders_service(created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_finance_company_id           ON finance_transactions(company_id);
CREATE INDEX IF NOT EXISTS idx_suppliers_company_id         ON suppliers(company_id);
CREATE INDEX IF NOT EXISTS idx_architects_company_id        ON architects(company_id);
